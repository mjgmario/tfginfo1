...
public class AmigosHanEstadoAdapter extends RecyclerView.Adapter<AmigosHanEstadoAdapter.AmigosHanEstadoViewholder> {
    private final ArrayList<Usuario_Local> listaLocalUser;
    private final LayoutInflater vInflater;

    public AmigosHanEstadoAdapter(Context context, ArrayList<Usuario_Local> lista){
    ...
    @NonNull
    @Override
    public AmigosHanEstadoViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View votacionView = vInflater.inflate(R.layout.componente_han_estado_local, parent, false);
        return new AmigosHanEstadoAdapter.AmigosHanEstadoViewholder(votacionView, this);


    }

    @Override // ver si es administrador
    public void onBindViewHolder(@NonNull AmigosHanEstadoAdapter.AmigosHanEstadoViewholder holder, int position) {
    ...
    public class  AmigosHanEstadoViewholder extends RecyclerView.ViewHolder {

        public TextView nombre;
        public final AmigosHanEstadoAdapter vAdapter;

        public AmigosHanEstadoViewholder(View vista, AmigosHanEstadoAdapter publicacionesAdapter ){
            super(vista);
